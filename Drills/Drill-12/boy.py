...
class SleepState:
    ...
    def do(boy):
        ...
        if(boy.ghostuptimer<=boy.r and boy.ghoststart ==0):
            boy.ghostuptimer+=boy.r/100
        elif(boy.ghostuptimer>=boy.r and boy.ghoststart==0):
            boy.ghostcirclestarttimer=get_time()
            boy.ghoststart=1
            boy.ghostuptimer=0
        if(boy.ghostcirclestarttimer>0):
            boy.ghostcircletimer=boy.ghostcirclestarttimer - get_time()
        elif(boy.ghostcircletimer>=1):
            boy.ghostcirclestarttimer=get_time()
